...
///////////// HP Info End //////////////////
    ...
    function sendPageInfo() {
        if (mountRobotContainer.visible) {
...
//////////////////////////////////////////////////////////////////////////////////////
    ...
    Rectangle {
        ...
        Text {
            ...
            text: "Fasten the interface to the handle of endoscope"
            font.pixelSize: 50
        ...
        Image {
            ...
            width: 360; height: 318
            clip: true; cache: false
            source: pngRoSE + "mount_endoscope.png"
        }
