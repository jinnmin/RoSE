...
Rectangle {
    ...
    readonly property string fwSonoVer: "FW RMFW Ver. v"
    readonly property string swVer:     "SW Ver. v 0.003"
    ...
    Image {
        ...
        Popup {
            ...
            Text {
                id: updateText
                text: qsTr("Firmware updating... /n Please Wait!")
                x: 50
                width: 352; height: 60
                    ...
                    if (closeTimer.repeat) {
                        switch(updateStatus) {
                            case waiting_for_mcu:
                                ...
                                closeTimer.restart()
                                if(selectedItem != gtMainBD)
                                    UserIface.updateFwRms(selectedItem, true)
